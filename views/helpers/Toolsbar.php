...
class Klear_View_Helper_Toolsbar extends Klear_View_Helper_Base
{
    ...
    public function Toolsbar()
    {
        ...
        $ret .= '<input type="checkbox" id="hideTabLabelNames" />' .
                '<label for="hideTabLabelNames" class="primary" title="' .$this->_view->translate("Hide/Show unselected tab names.") . '">'.
                '<span class="ui-icon ui-icon ui-icon-arrowstop-1-w" ></span></label>';
