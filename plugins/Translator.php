...
class Klear_Plugin_Translator extends Zend_Controller_Plugin_Abstract
{
     ...
     */
    protected $_Zend_Translate_Adapter = 'array';
    
    protected $_Zend_Translate_Content = array('Zend_Translate_Content'=>'Zend_Translate_Content');
    ...
    protected function _initKlearTranslator()
    {
        ...
        $this->_Zend_Translate_Adapter = 'Iron_Translate_Adapter_Translator';
        ...
        if (file_exists($this->_translationFile)) {
            ...
            if (empty($translations)) {
                $translations = $this->_Zend_Translate_Content;
            }
    ...
    protected function _initZendTranslate()
    {
    	if (!Zend_Registry::isRegistered('Zend_Translate')) {
    		$this->_translate = new Zend_Translate(	
				array(
					'adapter' => $this->_Zend_Translate_Adapter,
					'content' => $this->_Zend_Translate_Content,
				)
			);
